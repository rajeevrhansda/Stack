...
{
    float oldWidth, olddepth, oldOffset;//
    ...
    private bool CalculatePlatformDistance()
    {
        ...
        if (distance <= allowedDistance)
        {
            ...
            if (!perfect)
            {
                ...
                if (_uimanager.soundaAllow)
                {
                    _gamemanager.PlaySound("fStack");
        ...
        else
        {
            ...
            _gamemanager.SwitchAllowedTrue();//
                
            ConvertDynamicPlatform(dynamicPlatform);//
            DestroyDynamicPlatform(dynamicPlatform);//
            SpawnDynamicPlatform(oldWidth, olddepth, oldOffset);//
